...
export const FOOD_DB: FoodFact[] = [
  { aliases: ['whey protein shake', 'protein shake', 'whey shake', 'whey scoop', 'protein powder', 'whey protein'], serving: '1 scoop (~30g) in water/milk', kcal: 120, protein: 24, carbs: 3, fat: 1.5 },
  { aliases: ['mass gainer shake', 'mass gainer'], serving: '1 serving', kcal: 650, protein: 50, carbs: 90, fat: 8 },
  { aliases: ['banana'], serving: '1 medium (118g)', kcal: 105, protein: 1.3, carbs: 27, fat: 0.4 },
  { aliases: ['apple'], serving: '1 medium (182g)', kcal: 95, protein: 0.5, carbs: 25, fat: 0.3 },
  { aliases: ['whole egg', 'egg', 'boiled egg', 'fried egg'], serving: '1 large egg', kcal: 72, protein: 6.3, carbs: 0.4, fat: 5 },
  { aliases: ['egg white', 'egg whites'], serving: '1 large white', kcal: 17, protein: 3.6, carbs: 0.2, fat: 0.1 },
  { aliases: ['chicken breast', 'grilled chicken', 'chicken breast cooked'], serving: '100g cooked', kcal: 165, protein: 31, carbs: 0, fat: 3.6 },
  ...
  { aliases: ['peanut butter'], serving: '2 tbsp (32g)', kcal: 188, protein: 8, carbs: 6, fat: 16 },
  { aliases: ['salmon', 'salmon fillet'], serving: '100g cooked', kcal: 208, protein: 22, carbs: 0, fat: 13 },
  { aliases: ['sweet potato'], serving: '1 medium baked (114g)', kcal: 103, protein: 2.3, carbs: 24, fat: 0.2 },
  { aliases: ['avocado'], serving: '1/2 medium (68g)', kcal: 114, protein: 1.3, carbs: 6, fat: 10.5 },
  { aliases: ['cottage cheese'], serving: '1/2 cup (113g)', kcal: 90, protein: 12, carbs: 4, fat: 2.5 },
  { aliases: ['tuna', 'canned tuna'], serving: '1 can drained (142g)', kcal: 128, protein: 29, carbs: 0, fat: 1 },
  { aliases: ['broccoli'], serving: '1 cup cooked (156g)', kcal: 55, protein: 3.7, carbs: 11, fat: 0.6 },
  { aliases: ['creatine'], serving: '5g', kcal: 0, protein: 0, carbs: 0, fat: 0 },
]
...
export function foodDbForPrompt(): string {
  ...
  return `KNOWN FOOD DATABASE (use these exact figures when the item matches — never invent different numbers for these items):\n${rows.join('\n')}\nFor any food NOT in this list and not given explicit numbers by the user, do not guess a precise kcal/macro figure — ask for the label or a rough description instead.`
}
